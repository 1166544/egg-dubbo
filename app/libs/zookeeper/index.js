...
const NZD = function (opt) {
  ...
  console.log('Trying to connect >>>>>', this.application);
  this.client.connect();
  this.client.once('connected', () => {
    console.log('\x1b[32m%s\x1b[0m', 'Dubbo application [' + this.application.name + '] connected successfully.');
    self._applyServices();
    self._consumer();
  });
};
